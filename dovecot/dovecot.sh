...
echo "user_query = SELECT CONCAT('/home/mail/',LCASE("'`domain`'"),""'/'"",LCASE("'`maildir`'")),""1024 AS uid, 1024 AS gid FROM mailbox WHERE username = '%u'" >> /etc/dovecot/dovecot-sql.conf.ext
